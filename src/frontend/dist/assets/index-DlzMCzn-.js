...
var MutationCache = (_g = class extends Subscribable {
  ...
  find(filters2) {
    const defaultedFilters = { exact: true, ...filters2 };
    return this.getAll().find(
      (mutation) => matchMutation(defaultedFilters, mutation)
    );
  }
  findAll(filters2 = {}) {
    return this.getAll().filter((mutation) => matchMutation(filters2, mutation));
  }
  notify(event) {
    notifyManager.batch(() => {
      this.listeners.forEach((listener) => {
...
var QueryCache = (_h = class extends Subscribable {
  ...
  findAll(filters2 = {}) {
    ...
    return Object.keys(filters2).length > 0 ? queries.filter((query) => matchQuery(filters2, query)) : queries;
  }
  notify(event) {
    notifyManager.batch(() => {
      this.listeners.forEach((listener) => {
...
var QueryClient = (_i = class {
  ...
  isFetching(filters2) {
    return __privateGet(this, _queryCache).findAll({ ...filters2, fetchStatus: "fetching" }).length;
  }
  isMutating(filters2) {
    return __privateGet(this, _mutationCache2).findAll({ ...filters2, status: "pending" }).length;
  }
  /**
  ...
  getQueriesData(filters2) {
    return __privateGet(this, _queryCache).findAll(filters2).map(({ queryKey, state }) => {
  ...
  setQueriesData(filters2, updater, options) {
    return notifyManager.batch(
      () => __privateGet(this, _queryCache).findAll(filters2).map(({ queryKey }) => [
        queryKey,
  ...
  removeQueries(filters2) {
    ...
    notifyManager.batch(() => {
      queryCache.findAll(filters2).forEach((query) => {
        queryCache.remove(query);
      });
    });
  }
  resetQueries(filters2, options) {
    const queryCache = __privateGet(this, _queryCache);
    return notifyManager.batch(() => {
      queryCache.findAll(filters2).forEach((query) => {
        query.reset();
  ...
  cancelQueries(filters2, cancelOptions = {}) {
    const defaultedCancelOptions = { revert: true, ...cancelOptions };
    const promises = notifyManager.batch(
      () => __privateGet(this, _queryCache).findAll(filters2).map((query) => query.cancel(defaultedCancelOptions))
    );
    return Promise.all(promises).then(noop$6).catch(noop$6);
  }
  invalidateQueries(filters2, options = {}) {
    return notifyManager.batch(() => {
      __privateGet(this, _queryCache).findAll(filters2).forEach((query) => {
        query.invalidate();
      });
      if ((filters2 == null ? void 0 : filters2.refetchType) === "none") {
        return Promise.resolve();
      }
      return this.refetchQueries(
        {
          ...filters2,
          type: (filters2 == null ? void 0 : filters2.refetchType) ?? (filters2 == null ? void 0 : filters2.type) ?? "active"
        },
        options
      );
    });
  }
  refetchQueries(filters2, options = {}) {
    const fetchOptions = {
      ...options,
      cancelRefetch: options.cancelRefetch ?? true
    };
    const promises = notifyManager.batch(
      () => __privateGet(this, _queryCache).findAll(filters2).filter((query) => !query.isDisabled() && !query.isStatic()).map((query) => {
      ...
      children: tabs.map((tab) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            className: `flex flex-col items-center gap-0.5 px-4 py-2 rounded-full transition-all duration-200 ${isActive ? "btn-primary-gradient text-white shadow-pink" : "text-gray-400 hover:text-pink-400"}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { size: 20, strokeWidth: isActive ? 2.5 : 2 }),
...
function ChatScreen({ character, onBack }) {
  ...
  const [showTyping, setShowTyping] = reactExports.useState(true);
  const handleSend = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full min-h-screen gradient-bg", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "px-4 pt-6 pb-4 flex items-center gap-3 card-glass border-b border-pink-100/50", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronLeft, { size: 20, className: "text-gray-600" })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-sm text-gray-800", children: character.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-1", children: character.isOnline ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-1.5 h-1.5 rounded-full bg-green-400" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-green-500 font-medium", children: "Online now" })
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-400", children: "Last seen recently" }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Heart,
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 my-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 h-px bg-pink-100" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-gray-400 font-medium", children: "Today" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 h-px bg-pink-100" })
          ] }),
          character.chatMessages.map((msg, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: `flex items-end gap-2 ${msg.from === "user" ? "flex-row-reverse" : ""}`,
              "data-ocid": `chat.item.${i + 1}`,
              children: [
                msg.from === "character" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[75%]", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      className: `px-3.5 py-2.5 text-sm leading-relaxed ${msg.from === "character" ? "chat-bubble-left text-gray-700" : "chat-bubble-right text-purple-700"}`,
                      children: msg.text
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          showTyping && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "chat-bubble-left px-4 py-3 flex items-center gap-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-pink-400 typing-dot" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-pink-400 typing-dot" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-pink-400 typing-dot" })
            ] })
          ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 py-3 card-glass border-t border-pink-100/50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 bg-white/80 rounded-full px-4 py-2.5 border border-pink-100 shadow-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
...
function FavoritesScreen({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "gradient-bg min-h-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "px-5 pt-6 pb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { size: 22, className: "fill-pink-400 text-pink-400" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-extrabold text-gray-800", children: "Favorites" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500", children: "Your favourite companions 💕" })
    ] }),
    liked.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "flex flex-col items-center justify-center px-8 py-16 text-center",
        "data-ocid": "favorites.empty_state",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-20 h-20 rounded-full bg-gradient-to-br from-pink-200 to-purple-200 flex items-center justify-center mb-4 shadow-pink", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { size: 36, className: "text-pink-400" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold text-gray-700 mb-2", children: "No favorites yet!" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500 leading-relaxed", children: "Your matches will appear here 💕 Start liking characters to see them here!" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 flex items-center gap-1 text-pink-400", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { size: 14 }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold", children: "Tap the ♥ on any character card" })
          ] })
        ]
      }
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-5 pb-6 space-y-3", children: liked.map((char, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-sm text-gray-800", children: char.name }),
              char.isOnline && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2 h-2 rounded-full bg-green-400" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500 truncate mt-0.5", children: char.tagline }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1 mt-1", children: char.personalityTags.slice(0, 2).map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
...
function CharacterCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      "data-ocid": `character.card.${index2}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              character.isOnline && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-3 right-3 flex items-center gap-1 bg-white/80 backdrop-blur rounded-full px-2 py-0.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-1.5 h-1.5 rounded-full bg-green-400 animate-pulse" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] font-semibold text-green-600", children: "Online" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
                  "data-ocid": `character.toggle.${index2}`,
                  onClick: (e) => {
                    e.stopPropagation();
                    onToggleLike();
                  },
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-sm text-gray-800 truncate", children: character.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400 mt-0.5 truncate", children: character.tagline }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1 mt-2", children: character.personalityTags.slice(0, 2).map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              type: "button",
              "data-ocid": `character.primary_button.${index2}`,
...
function HomeScreen({
  ...
  const filteredChars = activeFilter === "Online" ? characters.filter((c) => c.isOnline) : characters;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "gradient-bg min-h-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "px-5 pt-6 pb-4 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { size: 22, className: "fill-pink-400 text-pink-400" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl font-bold text-gradient-pink", children: "Aimi" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Bell, { size: 18, className: "text-gray-500" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-0.5 -right-0.5 w-3.5 h-3.5 rounded-full bg-pink-500 border-2 border-white flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[7px] text-white font-bold", children: "3" }) })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-full bg-gradient-to-br from-pink-300 to-purple-300 flex items-center justify-center shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-bold text-white", children: "M" }) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "px-5 pb-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 mb-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { size: 16, className: "text-pink-400" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-pink-400 font-semibold", children: "✨ 142 matches today!" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-2xl font-extrabold text-gray-800 leading-tight", children: [
        "Discover Your Perfect",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-gradient-pink", children: "Anime Companion!" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500 mt-1.5", children: "Meet your favourite anime friends & find your match ✨" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-5 mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 bg-white/70 backdrop-blur rounded-full px-4 py-2.5 shadow-sm border border-pink-100", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { size: 16, className: "text-gray-400 flex-shrink-0" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-5 mb-5 flex gap-2 overflow-x-auto", children: filters.map((filter) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
        "data-ocid": "home.filter.tab",
        onClick: () => setActiveFilter(filter),
        className: `flex-shrink-0 px-4 py-1.5 rounded-full text-xs font-semibold transition-all duration-200 ${activeFilter === filter ? "btn-primary-gradient text-white shadow-pink" : "bg-white/60 text-gray-500 border border-pink-100 hover:border-pink-300"}`,
        children: filter
      },
      filter
    )) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "px-4 pb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3 px-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-bold text-base text-gray-800", children: "Characters" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-pink-400 font-semibold", children: [
          filteredChars.length,
          " online"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3", children: filteredChars.map((char, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        CharacterCard,
        {
          character: char,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "px-5 py-4 text-center border-t border-pink-100/50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[10px] text-gray-400", children: [
      "© ",
...
function ProfileScreen({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "gradient-bg min-h-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "px-4 pt-6 pb-3 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-gray-700", children: "Profile" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "px-5 pb-5 flex flex-col items-center text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
        ...
        character.isOnline && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-1 right-1 w-5 h-5 rounded-full bg-green-400 border-2 border-white shadow" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-extrabold text-gray-800 mt-3", children: character.name }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-semibold bg-pink-100 text-pink-600 px-2.5 py-0.5 rounded-full", children: [
          "Age ",
          character.age
        ] }),
        character.isOnline && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-semibold bg-green-50 text-green-600 px-2.5 py-0.5 rounded-full flex items-center gap-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-green-400" }),
          "Online"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-pink-400 font-medium mt-1.5 italic", children: character.tagline })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-5 card-glass rounded-2xl p-4 flex justify-around mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 justify-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { size: 14, className: "text-pink-400" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-gray-800 text-sm", children: character.stats.friends })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-gray-400 mt-0.5", children: "Friends" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-px bg-pink-100" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 justify-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { size: 14, className: "text-pink-400" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-gray-800 text-sm", children: character.stats.likes })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-gray-400 mt-0.5", children: "Likes" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-px bg-pink-100" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 justify-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { size: 14, className: "text-purple-400" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-gray-800 text-sm", children: character.stats.topMatch ? "✓" : "–" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-gray-400 mt-0.5", children: "Top Match" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "px-5 mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-bold text-sm text-gray-700 mb-2", children: "About Me" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card-glass rounded-2xl p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-600 leading-relaxed", children: character.bio }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "px-5 mb-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-bold text-sm text-gray-700 mb-2", children: "Personality" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: character.personalityTags.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "span",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "px-5 mb-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-bold text-sm text-gray-700 mb-2", children: "Recent Activity" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: character.activityPosts.map((post) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card-glass rounded-2xl p-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-600 leading-relaxed", children: post }) }, post)) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "px-5 pb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 mb-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            onClick: onToggleLike,
            className: `flex-1 py-3 rounded-full font-bold text-sm flex items-center justify-center gap-2 shadow-pink transition-all duration-200 hover:opacity-90 ${isLiked ? "bg-pink-500 text-white" : "btn-primary-gradient text-white"}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { size: 16, className: isLiked ? "fill-white" : "" }),
              isLiked ? "Liked! 💕" : "💖 Like"
            ]
          }
        ),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { size: 16, className: "fill-white" }),
            "✨ Match!"
          ]
        }
      )
...
function UserProfileScreen() {
  const settingsItems = [
    ...
    { icon: CircleHelp, label: "Help & Support", desc: "Get assistance" },
    { icon: Settings, label: "Settings", desc: "App preferences" }
  ];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "gradient-bg min-h-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "px-5 pt-6 pb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-extrabold text-gray-800", children: "My Profile" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500 mt-0.5", children: "Manage your account ✨" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "px-5 mb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-glass rounded-3xl p-5 flex flex-col items-center text-center shadow-card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-20 h-20 rounded-full bg-gradient-to-br from-pink-300 to-purple-400 flex items-center justify-center shadow-pink mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(User, { size: 36, className: "text-white" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-extrabold text-lg text-gray-800", children: "Maya Tanaka" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-400 mt-0.5", children: "@maya_chan" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 mt-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { size: 12, className: "fill-yellow-400 text-yellow-400" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { size: 12, className: "fill-yellow-400 text-yellow-400" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { size: 12, className: "fill-yellow-400 text-yellow-400" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { size: 12, className: "fill-yellow-400 text-yellow-400" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { size: 12, className: "text-gray-300" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-500 ml-1", children: "4.2 rating" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-6 mt-4 pt-4 border-t border-pink-100 w-full justify-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-gray-800", children: "12" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-gray-400", children: "Matches" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-gray-800", children: "47" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-gray-400", children: "Liked" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-gray-800", children: "138" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-gray-400", children: "Chats" })
        ] })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "px-5 mb-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-bold text-sm text-gray-700 mb-2", children: "My Badges" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", children: [
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] font-semibold text-gray-600", children: badge.label })
          ]
        },
        badge.label
      )) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "px-5 pb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-bold text-sm text-gray-700 mb-2", children: "Settings" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card-glass rounded-2xl overflow-hidden shadow-card", children: settingsItems.map((item, i) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            className: `w-full flex items-center gap-3 px-4 py-3.5 hover:bg-pink-50/50 transition-colors text-left ${i < settingsItems.length - 1 ? "border-b border-pink-100/60" : ""}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-full bg-pink-50 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { size: 16, className: "text-pink-400" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-sm text-gray-700", children: item.label }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-gray-400", children: item.desc })
              ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-5 pb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { size: 16, className: "fill-pink-400 text-pink-400" }),
          "Edit Profile"
        ]
      }
    ) })
...
function App() {
  ...
  const [likedIds, setLikedIds] = reactExports.useState(/* @__PURE__ */ new Set([1, 3]));
  const toggleLike = (id) => {
    setLikedIds((prev) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gradient-bg min-h-screen flex items-center justify-center p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          style: {
            minHeight: "85vh",
            boxShadow: "0 32px 80px rgba(245, 167, 198, 0.35), 0 8px 24px rgba(0,0,0,0.1)"
          },
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-full overflow-y-auto", style: { paddingBottom: 80 }, children: [
              ...
              screen === "profile" && selectedCharacter && /* @__PURE__ */ jsxRuntimeExports.jsx(
                ProfileScreen,
                {
              ...
              screen === "chat" && selectedCharacter && /* @__PURE__ */ jsxRuntimeExports.jsx(
                ChatScreen,
                {
                  character: selectedCharacter,
              ...
              screen === "favorites" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                FavoritesScreen,
                {
                  likedIds,
                  onOpenProfile: openProfile
              ...
              screen === "user-profile" && /* @__PURE__ */ jsxRuntimeExports.jsx(UserProfileScreen, {})
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-0 right-0 px-4 pb-4 pt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BottomNav, { activeTab, onTabChange: handleTabChange }) })
          ]
        }
      )
    }
